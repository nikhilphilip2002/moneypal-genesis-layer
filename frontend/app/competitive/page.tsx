...
function InstitutionDetail({ institution }: { institution: Institution }) {
  ...
  return (
    <div className="space-y-4 pb-8">
      {profile.loading && <LoadingCard lines={8} showStatus />}
      ...
      {swot.loading && <LoadingCard lines={6} showStatus stages={['Fetching institution data', 'Analyzing strengths & risks', 'Generating SWOT']} />}
