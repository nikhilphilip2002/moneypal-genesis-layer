...
CHAINS: tuple[Chain, ...] = (
    ...
    # =========================================================================
    Chain(1, "Agent Operations", "Top Agents by Customer Volume", (
    ...
    Chain(2, "Agent Operations", "Agent Origination Ranking", (
    ...
    Chain(3, "Agent Operations", "Agent Sourcing Quality and Exposure", (
    ...
    Chain(4, "Agent Operations", "Agent Collection Performance", (
    ...
    Chain(5, "Agent Operations", "Recently Joined Field Agents", (
    ...
    Chain(6, "Agent Operations", "Field Agent Sanctions vs Disbursements", (
    ...
    Chain(7, "Agent Operations", "Agent Tenure and Productivity", (
    ...
    Chain(8, "Agent Operations", "Sales Hierarchy and Reporting Lines", (
    ...
    Chain(9, "Agent Operations", "Collections Hierarchy and Arrears", (
    ...
    Chain(10, "Agent Operations", "Agent Portfolio At Risk", (
    ...
    # =========================================================================
    Chain(11, "Branch Network", "Branch Directory & Office Status", (
    ...
    Chain(12, "Branch Network", "Branch Disbursement Leaders", (
    ...
    Chain(13, "Branch Network", "Branch Customer Franchise (Ujire)", (
    ...
    Chain(14, "Branch Network", "Branch Portfolio Concentration", (
    ...
    Chain(15, "Branch Network", "Branch Collections & Repayments", (
    ...
    Chain(16, "Branch Network", "Branch Delinquency & PAR 30", (
    ...
    Chain(17, "Branch Network", "Coastal vs Hinterland Performance", (
    ...
    Chain(18, "Branch Network", "Branch Sanction-to-Disbursement Pipeline", (
    ...
    Chain(19, "Branch Network", "Branch Growth & Monthly Trajectory", (
    ...
    Chain(20, "Branch Network", "Branch Ticket Size Dynamics", (
    ...
    Chain(21, "Branch Network", "Branch Asset Classification Profile", (
    ...
    Chain(22, "Branch Network", "Branch Loan Closure Trends", (
    ...
    # =========================================================================
    Chain(23, "Schemes & Products", "Scheme Portfolio & Outstanding Balance", (
    ...
    Chain(24, "Schemes & Products", "Product Scheme Pricing & Term Bounds", (
    ...
    Chain(25, "Schemes & Products", "Gold Loan Performance", (
    ...
    Chain(26, "Schemes & Products", "Business & MSME Lending Schemes", (
    ...
    Chain(27, "Schemes & Products", "Personal Loan Portfolio", (
    ...
    Chain(28, "Schemes & Products", "Scheme Sanction-to-Disbursement Conversion", (
    ...
    Chain(29, "Schemes & Products", "Scheme Repayment Cash Flows", (
    ...
    Chain(30, "Schemes & Products", "Scheme Interest Rate Spread & Yield", (
    ...
    Chain(31, "Schemes & Products", "Scheme Delinquency & Overdue Balances", (
    ...
    Chain(32, "Schemes & Products", "Scheme Origination Vintage Growth", (
    ...
    Chain(33, "Schemes & Products", "Scheme Product Reporting Mappings", (
    ...
    Chain(34, "Schemes & Products", "High-Yield vs Low-Risk Scheme Mix", (
    ...
    # =========================================================================
    Chain(35, "Customer & KYC", "Gender Participation & Demographics", (
    ...
    Chain(36, "Customer & KYC", "Borrower Occupation Profiles", (
    ...
    Chain(37, "Customer & KYC", "KYC Verification Status", (
    ...
    Chain(38, "Customer & KYC", "KYC Document Inventory & Types", (
    ...
    Chain(39, "Customer & KYC", "KYC Document Expiry Pipeline", (
    ...
    Chain(40, "Customer & KYC", "Customer Age & Vintage Demographics", (
    ...
    Chain(41, "Customer & KYC", "Top Borrower Concentration Risk", (
    ...
    Chain(42, "Customer & KYC", "Repeat Borrowers & Multi-Loan Customers", (
    ...
    Chain(43, "Customer & KYC", "Customer Relationship Vintage", (
    ...
    Chain(44, "Customer & KYC", "PII & Profile Data Completeness", (
    ...
    # =========================================================================
    Chain(45, "Portfolio Balances", "Overall Loan Book Scale & Status Mix", (
    ...
    Chain(46, "Portfolio Balances", "Portfolio Outstanding Concentration", (
    ...
    Chain(47, "Portfolio Balances", "Active Loan Account Details", (
    ...
    Chain(48, "Portfolio Balances", "High-Ticket Loan Exposure", (
    ...
    Chain(49, "Portfolio Balances", "Loan Tenure & Amortization Mix", (
    ...
    Chain(50, "Portfolio Balances", "Interest Rate Slabs Portfolio Breakdown", (
    ...
    Chain(51, "Portfolio Balances", "Loan Vintage & Sanction Year Distribution", (
    ...
    Chain(52, "Portfolio Balances", "Fully Disbursed vs Staged Accounts", (
    ...
    Chain(53, "Portfolio Balances", "Loan Repayment Frequency Mix", (
    ...
    Chain(54, "Portfolio Balances", "Closed and Settled Accounts History", (
    ...
    # =========================================================================
    Chain(55, "Disbursements", "FYTD Disbursement Trajectory", (
    ...
    Chain(56, "Disbursements", "Disbursement Event Volumes & Ticket Size", (
    ...
    Chain(57, "Disbursements", "Quarterly Disbursement Momentum", (
    ...
    Chain(58, "Disbursements", "Multiple Drawdown Loans", (
    ...
    Chain(59, "Disbursements", "Branch Monthly Disbursement Consistency", (
    ...
    Chain(60, "Disbursements", "Disbursement vs Sanction Lag", (
    ...
    Chain(61, "Disbursements", "Recent Disbursement Inflow (Last 30 Days)", (
    ...
    Chain(62, "Disbursements", "First Disbursement vs Subsequent Releases", (
    ...
    Chain(63, "Disbursements", "High-Growth Disbursement Branches", (
    ...
    Chain(64, "Disbursements", "Seasonal Disbursement Trends", (
    ...
    # =========================================================================
    Chain(65, "Collections & Cash Flow", "Collection Efficiency Overview", (
    ...
    Chain(66, "Collections & Cash Flow", "Principal vs Interest Recovery Cash Flows", (
    ...
    Chain(67, "Collections & Cash Flow", "Disbursement and Collection Net Cash Flow", (
    ...
    Chain(68, "Collections & Cash Flow", "Scheduled Dues vs Actual Collections", (
    ...
    Chain(69, "Collections & Cash Flow", "Advance & Pre-closure Collections", (
    ...
    Chain(70, "Collections & Cash Flow", "Repayment Event Counts & Frequency", (
    ...
    Chain(71, "Collections & Cash Flow", "Branch Collection Efficiency Rankings", (
    ...
    Chain(72, "Collections & Cash Flow", "Scheme Collection Efficiency Dynamics", (
    ...
    Chain(73, "Collections & Cash Flow", "Overdue Interest Recovery", (
    ...
    Chain(74, "Collections & Cash Flow", "Recovery on Written-Off or NPA Loans", (
    ...
    Chain(75, "Collections & Cash Flow", "EMI Bounce & Arrears Inflow", (
    ...
    Chain(76, "Collections & Cash Flow", "Weighted Average Repayment Tenure", (
    ...
    # =========================================================================
    Chain(77, "Delinquency & PAR", "PAR 30 & Overdue Portfolio Scale", (
    ...
    Chain(78, "Delinquency & PAR", "Complete DPD Bucket Distribution", (
    ...
    Chain(79, "Delinquency & PAR", "Early Warning Signals (1-30 DPD)", (
    ...
    Chain(80, "Delinquency & PAR", "Mid-Stage Delinquency (31-60 DPD)", (
    ...
    Chain(81, "Delinquency & PAR", "Late-Stage Pre-NPA Stress (61-90 DPD)", (
    ...
    Chain(82, "Delinquency & PAR", "DPD Migration & Roll-Forward Rates", (
    ...
    Chain(83, "Delinquency & PAR", "Overdue Principal by Branch", (
    ...
    Chain(84, "Delinquency & PAR", "Overdue Principal by Lending Scheme", (
    ...
    Chain(85, "Delinquency & PAR", "Borrower Delinquency Concentration", (
    ...
    Chain(86, "Delinquency & PAR", "30-Day Trend in PAR 30", (
    ...
    Chain(87, "Delinquency & PAR", "High-Risk Vintage Analysis", (
    ...
    Chain(88, "Delinquency & PAR", "Secured vs Unsecured Delinquency", (
    ...
    # =========================================================================
    Chain(89, "Asset Quality & NPA", "Overall NPA Ratio & Scale", (
    ...
    Chain(90, "Asset Quality & NPA", "Asset Classification Distribution", (
    ...
    Chain(91, "Asset Quality & NPA", "Sub-Standard Accounts Deep Dive", (
    ...
    Chain(92, "Asset Quality & NPA", "NPA Movement & Slippages", (
    ...
    Chain(93, "Asset Quality & NPA", "NPA Resolution & Upgrades", (
    ...
    Chain(94, "Asset Quality & NPA", "Top NPA Borrowers Analysis", (
    ...
    Chain(95, "Asset Quality & NPA", "Branch NPA League Table", (
    ...
    Chain(96, "Asset Quality & NPA", "Scheme NPA Vulnerability", (
    ...
    # =========================================================================
    Chain(97, "Audit & Worklists", "High-Exposure Borrower Portfolio Review", (
    ...
    Chain(98, "Audit & Worklists", "Zero-Disbursement Sanction Audit", (
    ...
    Chain(99, "Audit & Worklists", "High-Interest Short-Tenure Stress Review", (
    ...
    Chain(100, "Audit & Worklists", "Executive Loan Book Master Health Check", (
