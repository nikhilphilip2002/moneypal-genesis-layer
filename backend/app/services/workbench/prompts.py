...
AGENT_SYSTEM_PROMPT = (
    ...
    "January 1 through December 31 bounds. Any explicit monthwise, month-wise, month wise, "
    "monthly, by-month, or each-month wording requires the month dimension for every "
    "time-compatible governed flow metric, including interest_collected. When a request "
    "combines a ranking at one grain with detail rows at another "
