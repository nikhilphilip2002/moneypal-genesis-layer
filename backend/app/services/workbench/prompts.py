...
AGENT_SYSTEM_PROMPT = (
    ...
    "from memory. Keep generated SQL bounded: filter early, aggregate one-to-many data before "
    "joining, and avoid correlated subqueries. If a query times out, simplify or narrow it and "
