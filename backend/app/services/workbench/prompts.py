...
AGENT_SYSTEM_PROMPT = (
    ...
    "For a follow-up asking to visualize an existing query result, call "
    "visualize_query_result and choose the chart fields and aggregation from its stored result. "
